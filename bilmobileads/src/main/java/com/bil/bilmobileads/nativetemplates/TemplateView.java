...
public class TemplateView extends FrameLayout {
    ...
    private ADNativeView nativeAdView;
    ...
    public ADNativeView getNativeAdView() {
        return nativeAdView;
    }
    ...
    public void onFinishInflate() {
        ...
        nativeAdView = (ADNativeView) findViewById(R.id.native_ad_view);
